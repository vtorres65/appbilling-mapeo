...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_NAME_CONTACT = "AAAAAAAAAA";
    private static final String UPDATED_NAME_CONTACT = "BBBBBBBBBB";
    ...
    public static Customer createEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .nameContact(DEFAULT_NAME_CONTACT)
            .email(DEFAULT_EMAIL)
    ...
    public static Customer createUpdatedEntity(EntityManager em) {
        Customer customer = new Customer()
            ...
            .nameContact(UPDATED_NAME_CONTACT)
            .email(UPDATED_EMAIL)
    ...
    void createCustomer() throws Exception {
        ...
        assertThat(testCustomer.getSocialReason()).isEqualTo(DEFAULT_SOCIAL_REASON);
        assertThat(testCustomer.getNameContact()).isEqualTo(DEFAULT_NAME_CONTACT);
        assertThat(testCustomer.getEmail()).isEqualTo(DEFAULT_EMAIL);
        assertThat(testCustomer.getPhoneNumber()).isEqualTo(DEFAULT_PHONE_NUMBER);
        assertThat(testCustomer.getStatusClient()).isEqualTo(DEFAULT_STATUS_CLIENT);
    }
    ...
    @Test
    @Transactional
    void checkNameContactIsRequired() throws Exception {
        int databaseSizeBeforeTest = customerRepository.findAll().size();
        // set the field null
        customer.setNameContact(null);
    ...
    void getAllCustomers() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.[*].nameContact").value(hasItem(DEFAULT_NAME_CONTACT)))
    ...
    void getCustomer() throws Exception {
        ...
        restCustomerMockMvc
            ...
            .andExpect(jsonPath("$.nameContact").value(DEFAULT_NAME_CONTACT))
    ...
    void putNewCustomer() throws Exception {
        ...
        Customer testCustomer = customerList.get(customerList.size() - 1);
        assertThat(testCustomer.getSocialReason()).isEqualTo(UPDATED_SOCIAL_REASON);
        assertThat(testCustomer.getNameContact()).isEqualTo(UPDATED_NAME_CONTACT);
        assertThat(testCustomer.getEmail()).isEqualTo(UPDATED_EMAIL);
        assertThat(testCustomer.getPhoneNumber()).isEqualTo(UPDATED_PHONE_NUMBER);
        assertThat(testCustomer.getStatusClient()).isEqualTo(UPDATED_STATUS_CLIENT);
    }
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.socialReason(UPDATED_SOCIAL_REASON).statusClient(UPDATED_STATUS_CLIENT);
